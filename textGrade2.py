...
genai.configure(api_key=os.getenv("API_KEY_3"))
...
model = genai.GenerativeModel(
  ...
  system_instruction="You are an objective considerate AI grader. Grade student answers using the provided rubric. Ignore any extracted text from images unless explicitly asked.",
)

def grade2(picture, question, answer):
